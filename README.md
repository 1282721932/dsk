...
This is the code for NeurIPS 2025
paper Distilling Structured Knowledge for Universal Information Extraction
## Requirements
...
```text
{"tokens": ["While", "the", "attack", "was", "certainly", "high", "profile", ",", "mistakes", "in", "the", "code", "meant", "many", "victims", "of", "WannaCry", "were", "able", "to", "successfully", "unlock", "systems", "without", "giving", "into", "the", "demands", "of", "hackers", "."], "entity": [{"type": "person", "offset": [29], "text": "hackers"}, {"type": "person", "offset": [14], "text": "victims"}, {"type": "system", "offset": [22], "text": "systems"}], "relation": [], "event": [{"type": "ransom", "offset": [26, 27], "text": "the demands", "args": [{"type": "attacker", "offset": [29], "text": "hackers"}]}, {"type": "ransom", "offset": [16], "text": "WannaCry", "args": [{"type": "victim", "offset": [14], "text": "victims"}, {"type": "victim", "offset": [22], "text": "systems"}]}, {"type": "ransom", "offset": [1, 2], "text": "the attack", "args": []}]}
{"tokens": ["In", "the", "months", "since", "the", "attack", ",", "the", "bitcoin", "wallets", "containing", "the", "money", "extorted", "by", "WannaCry", "were", "left", "untouched", ",", "but", "August", "3", "saw", "them", "suddenly", "start", "to", "be", "emptied", "."], "entity": [{"type": "time", "offset": [1, 2], "text": "the months"}, {"type": "payment method", "offset": [7, 8, 9], "text": "the bitcoin wallets"}, {"type": "malware", "offset": [15], "text": "WannaCry"}], "relation": [], "event": [{"type": "ransom", "offset": [4, 5], "text": "the attack", "args": [{"type": "time", "offset": [1, 2], "text": "the months"}, {"type": "payment method", "offset": [7, 8, 9], "text": "the bitcoin wallets"}]}, {"type": "ransom", "offset": [12, 13], "text": "money extorted", "args": [{"type": "tool", "offset": [15], "text": "WannaCry"}]}]}
```
...
```shell
# dconll2003
CUDA_VISIBLE_DEVICES=1 python train_ner.py --lr 3e-5 -b 32 -n 30 -d dconll2003 --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1
# dontonotes
CUDA_VISIBLE_DEVICES=2 python train_ner.py --lr 1e-5 -b 32 -n 30 -d dontonotes --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1

# ace2004
CUDA_VISIBLE_DEVICES=3 python train_ner.py --lr 2e-5 -b 32 -n 30 -d ace2004 --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1

# ace2005
CUDA_VISIBLE_DEVICES=4 python train_ner.py --lr 3e-5 -b 32 -n 30 -d ace2005 --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1

# genia
CUDA_VISIBLE_DEVICES=5 python train_ner.py --lr 7e-6 -b 32 -n 30 -d genia --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1
```
...
```shell
# ace2005
CUDA_VISIBLE_DEVICES=6 python train_re.py  --lr 3e-5 -b 32 -n 200 -d ace2005 --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1
# conll04
CUDA_VISIBLE_DEVICES=7 python train_re.py  --lr 3e-5 -b 32 -n 200 -d conll04 --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1
# sci
CUDA_VISIBLE_DEVICES=1 python train_re.py  --lr 3e-5 -b 32 -n 200 -d sciere --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1
```
...
```shell
# ACE05E
CUDA_VISIBLE_DEVICES=1 python train_ee.py --lr 3e-5 -b 32 -n 200 -d ace05e --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1

# CASIE
CUDA_VISIBLE_DEVICES=3 python train_ee.py --lr 3e-5 -b 32 -n 200 -d casie --dropout 0.4 --input_size 1024 --hidden_size 200 --output_size 100 --warmup 0.1
```
...
- [Deberta-Large V3](https://hf-mirror.com/microsoft/deberta-v3-large)
